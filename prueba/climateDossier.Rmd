...
|----------|-----------|-------------------------------------------|-------------------------------------------------------------------|--------------------------------------------------------|-------------------------------------------------------------------------------------------------|------------------|
| precip   | tau > 0   | `r nrow(p_precip_sn[p_precip_sn$tau>0,])` | `r (nrow(p_precip_sn[p_precip_sn$tau>0,])/nrow(p_precip_sn))*100` | `r nrow(filter(p_precip_sn, tau > 0, p_value < 0.05))` | `r (nrow(filter(p_precip_sn, tau > 0, p_value < 0.05))/nrow(filter(p_precip_sn, tau > 0)))*100` |                  |
| precip   | tau < 0   |                                           |                                                                   |                                                        |                                                                                                 |                  |
